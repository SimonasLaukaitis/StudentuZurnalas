...
public:
	...
	////OVERLOADINAU == OPERATORIU
	bool operator==( Student& c1);

	//overloadinimas neveikiantis
...
__declspec(selectany) int homeWorkCount = 0; //__declspec(selectany) kad nesidubliuotu su kitais failais
...
list<Student> raskMinkstus(list<Student>&);

bool gavoSkola(Student);
